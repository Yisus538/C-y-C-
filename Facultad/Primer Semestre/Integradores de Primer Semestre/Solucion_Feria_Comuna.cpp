...
por los lugareños, y se ofrecen shows y comidas al paso. La comuna se encarga de gestionar el evento separando 
por sectores, y en cada uno de ellos hay un puesto, ademas la comuna ofrece los servicios de luz, agua y baños 
...
ingrese los siguientes datos: rubro al que pertenece (1-ArtesanÃ­a, 2-GastronomÃ­a o 3-Espectaculo), si requiere mesa 
...
c. Mostrar la matriz de solicitudes por rubro de EspectÃ¡culo.
