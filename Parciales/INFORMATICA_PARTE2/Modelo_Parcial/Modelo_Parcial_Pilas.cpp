...
int Menu();
void push(Node **pila,struct Equipo e);
void print(Node *pila);
void puntaje(Node *pila);
void Nunca(Node *pila);
void Grabar(Node *pila);
...
void push(Node **pila,struct Equipo e){
    ...
    //new_node = new Node(); se puede escribir asi siempre y cuando no se use la funcion realloc.
